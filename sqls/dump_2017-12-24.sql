...
1	pbkdf2_sha256$30000$2j8nisBGCA4o$HKfUAjblumCQYZ+li0fVoy3/MDRteQjG+oDojkVAHto=	2017-11-24 21:49:23.52498+08	t	admin			benying1988@gmail.com	t	t	2017-05-26 16:28:41+08
\.
...
SELECT pg_catalog.setval('babycare_event_id_seq', 31, true);
...
158	-12349	装修	0	瓷砖	2017-12-20 21:48:10.642265+08	0	0	\N	2017-12-20 21:48:10.642645+08	\N	\N	10
...
SELECT pg_catalog.setval('babycare_iaer_id_seq', 171, true);
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 150, true);
